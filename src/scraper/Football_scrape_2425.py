...
# Config
# -----------------------------
BASE_DIR = "Premier_League_2024_2025"
...
def scrape_premier_league():
    ...
    with sync_playwright() as p:
        ...
        for a in team_links:
            href = a["href"]
            full_url = urljoin("https://fbref.com", href).replace("/2025-2026/", "/2024-2025/")
        ...
        for team_name, team_url in teams.items():
            ...
            if team_name_clean not in ["liverpool", "manchester city","newcastle utd","nott'ham forest","brentford","aston villa","chelsea","crystal palace","wolves"]:
                print(f"\n=== Team: {team_name} ===")
